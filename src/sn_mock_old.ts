...
declare class GlideQueryCondition_new  {
...
declare interface GlideQueryCondition {
     ...
     * @param {string|GlideIQueryCondition} name_OR_and The name of a field.
     * @param {any|QueryConditionOperator} [value_OR_oper] Value or operator.
     * @param {any} [value] The value of a field.
     * @param {*} value The value to query on.
     * @returns {GlideIQueryCondition} A reference to a GlideQueryConditon that was added to the GlideRecord.
     */
    addCondition(name_OR_and: string|GlideIQueryCondition, value_OR_oper?: any|QueryConditionOperator, value?: any) : GlideIQueryCondition;
    /**
...
declare class GlideRecord  {
	...
	addQuery(name: string, operatorOrValue: any, value?: any): GlideIQueryCondition;
...
declare class GlideElement_new  {
	canCreate(): boolean;
	canRead(): boolean;
	canWrite(): boolean;
	changes(): boolean;
