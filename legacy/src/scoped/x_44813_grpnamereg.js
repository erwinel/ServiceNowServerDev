...
var x_44813_grpnamereg;
(function (x_44813_grpnamereg) {
    /**
     * Utility methods for working with the Interop Group Names registry.
     */
    var GroupRegUtil = /** @class */ (function () {
        function GroupRegUtil() {
            this.type = "GroupRegUtil";
        }
        /**
         ...
         */
        GroupRegUtil.prototype.getRegRecordByGroupName = function (name) {
         ...
         */
        GroupRegUtil.prototype.ensureRegRecordByGroupName = function (name) {
         ...
         */
        GroupRegUtil.prototype.findSnGroupRecordByName = function (name, includeInactive) {
         ...
         * @returns {GlideRecord|undefined} The associated GlideRecord from the sys_group table or undefined if no system group was found.
         */
        GroupRegUtil.prototype.getGroupRecordByGroupName = function (name, includeInactive) {
            var regGr = new GlideRecord(GroupRegUtil.tableName);
            var groupGr;
            regGr.addQuery("group_name", name);
            regGr.query();
         ...
         */
        GroupRegUtil.prototype.getGroupSysIdByGroupName = function (name, validate, includeInactive) {
            var regGr = new GlideRecord(GroupRegUtil.tableName);
            var grpGr;
            regGr.addQuery("group_name", name);
            regGr.query();
    ...
    x_44813_grpnamereg.GroupRegUtil = GroupRegUtil;
})(x_44813_grpnamereg = exports.x_44813_grpnamereg || (exports.x_44813_grpnamereg = {}));
//# sourceMappingURL=x_44813_grpnamereg.js.map