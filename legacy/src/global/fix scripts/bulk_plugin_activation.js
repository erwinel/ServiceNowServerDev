...
(function (global) {
    var bg_scripts;
    (function (bg_scripts) {
        var bulk_plugin_activation;
        (function (bulk_plugin_activation) {
            ...
            try {
                ...
                if (queue.length > 0) {
                    ...
                    for (var index = 0; index < resultInfo.items.length; index++) {
                        ...
                        try {
                            var worker_1 = new GlidePluginManagerWorker();
                            worker_1.setPluginId(pluginInfo.id);
                            worker_1.setIncludeDemoData(false);
                            worker_1.setProgressName("Activate " + ((typeof (pluginInfo.name) == "string" && pluginInfo.name.trim().length > 0) ? pluginInfo.name : pluginInfo.id));
                            worker_1.setBackground(false);
                            worker_1.start();
                            var progressId = worker_1.getProgressID();
        ...
        })(bulk_plugin_activation = bg_scripts.bulk_plugin_activation || (bg_scripts.bulk_plugin_activation = {}));
    })(bg_scripts = global.bg_scripts || (global.bg_scripts = {}));
})(global = exports.global || (exports.global = {}));
//# sourceMappingURL=bulk_plugin_activation.js.map