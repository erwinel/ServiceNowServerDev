...
(function (x_44813_util) {
    var types = /** @class */ (function () {
         ...
         */
        types.prototype.defined = function (value) { return typeof (value) !== "undefined"; };
        /**
         * Tests whether a value is an object.
         * @param value Value to test.
         * @returns {boolean} True if the value's type is "object" and it is not null; otherwise false.
         */
        types.prototype.isObjectType = function (value) { return typeof (value) === "object" && value !== null; };
        /**
         ...
         */
        types.prototype.isNonArrayObject = function (value) { return typeof (value) == "object" && value !== null && !Array.isArray(value); };
        /**
         * Tests whether a value is a string
         * @param value Value to test.
         * @returns {boolean} True if the value is a string; otherwise, false.
         */
        types.prototype.isString = function (value) { return typeof (value) === "string"; };
        /**
         * Tests whether a value is a function.
         * @param value Value to test.
         * @returns {boolean} True if the value is a function; otherwise, false.
         */
        types.prototype.isFunction = function (value) { return typeof (value) === "function"; };
        /**
         * Tests whether a value is a boolean type.
         * @param value Value to test.
         * @returns {boolean} True if the value is boolean; otherwise, false.
         */
        types.prototype.isBoolean = function (value) { return typeof (value) === "boolean"; };
        /**
         * Tests whether a value is a number type.
         * @param value Value to test.
         * @returns {boolean} True if the value is a number and is not NaN; otherwise, false.
         */
        types.prototype.isNumber = function (value) { return typeof (value) === "number" && !isNaN(value); };
        /**
         * Tests whether a value is a number type.
         * @param value Value to test.
         * @returns {boolean} True if the value is a number and is not NaN; otherwise, false.
         */
        types.prototype.isInteger = function (value) { return typeof (value) === "number" && !isNaN(value) && Math.round(value) === value; };
        /**
         * Tests whether a value is undefined or null.
         * @param value Value to test.
         * @returns {boolean} True if the value is undefined or null; othwerise, false.
         */
        types.prototype.isNil = function (value) { return !this.defined(value) || value === null; };
        /**
         ...
         */
        types.prototype.isNilOrEmptyString = function (value) { return this.isNil(value) || (this.isString(value) && value.length == 0); };
        /**
         ...
         */
        types.prototype.isNilOrWhitespace = function (value) { return this.isNil(value) || (this.isString(value) && this.whitespaceRegex.test(value)); };
        /**
         ...
         */
        types.prototype.asString = function (value, defaultValue, ignoreWhitespace) {
         ...
         * Otherwise, this method first attempts to call the value's "valueOf" function it is an object type, then it comply calls the "toString" method to convert it to a string.
         */
        types.prototype.asNormalizedString = function (value, defaultValue) {
         ...
         */
        types.prototype.trimEnd = function (text) {
         ...
         */
        types.prototype.asNumber = function (value, defaultValue) {
            if (!this.defined(value)) {
                if (this.isNil(defaultValue))
         ...
         */
        types.prototype.asInteger = function (value, defaultValue) {
         ...
         */
        types.prototype.asBoolean = function (value, defaultValue) {
         ...
         */
        types.prototype.asArray = function (value) {
            if (!this.defined(value))
                return [];
         ...
         */
        types.prototype.getClassName = function (value) {
            if (!this.defined(value))
                return "undefined";
            if (value === null)
                return "null";
         ...
         */
        types.prototype.getInheritanceChain = function (value) {
            if (!this.defined(value))
                return ["undefined"];
            if (value === null)
                return ["null"];
         ...
         */
        types.prototype.derivesFrom = function (value, classConstructor) {
            if (!this.defined(value))
         ...
         */
        types.prototype.typeOfExt = function (value) {
            var t = typeof (value);
            if (t == "object") {
                if (value === null)
                    return "null";
         ...
         */
        types.prototype.indentText = function (text, indent, skipLineCount) {
            var arr, joinedText;
        ...
        types.prototype._serializeToString = function (obj) {
            if (!this.defined(obj))
                return "undefined";
            if (obj === null)
                return "null";
         ...
         */
        types.prototype.serializeToString = function (obj) {
            if (!this.defined(obj))
                return "undefined";
            if (obj === null)
                return "null";
